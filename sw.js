 ...
 */
var SURUM = 'tv-envanter-v26';
var KABUK = [
  './kitap-envanteri.html',
  './js/gonullu-config.js',
  './js/envanter-ag.js',
  './js/fotograf-goruntuleyici.js',
  './css/gonullu-yeni.css',
  './css/fotograf-goruntuleyici.css',
...
self.addEventListener('fetch', function (e) {
  ...
  if (adres.origin !== self.location.origin) return;        // Cloudflare fotoğrafları gibi dış kaynaklara karışma
