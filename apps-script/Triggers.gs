 ...
 * should show four rows. Anything else means a previous run left orphans;
...
function createTriggers() {
  ...
  // Hourly pull from the shared volunteer sheet into Firestore. See
